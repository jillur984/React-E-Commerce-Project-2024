...
const Collection = () => {
  ...
  const sortProduct = () => {
    const fpProductsCopy = filterProducts.slice()
    switch (sortType) {
      case "low-high": 
      ...
      <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t ">
        ...
        <div className="min-w-60">
          ...
          >
            ...
            <div className="flex flex-col gap-2 text-sm font-light text-gray-700 ">
              <p className="flex gap-2">
                <input type="checkbox" name="" id="" value={"Topwear"} onChange={toggleSubCategory} />{" "}
                Topwear
              </p>
              <p className="flex gap-2">
                <input type="checkbox" name="" id="" value={"Bottomwear"} onChange={toggleSubCategory} />{" "}
                Bottomwear
              </p>
              <p className="flex gap-2">
                <input type="checkbox" name="" id="" value={"Winterwear"} onChange={toggleSubCategory} />{" "}
                Winterwear
              </p>
            </div>
          </div>
